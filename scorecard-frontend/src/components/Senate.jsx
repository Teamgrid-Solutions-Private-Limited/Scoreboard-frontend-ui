...
const SenateScorecard = () => {
  ...
  const sessions = {
    "2023-2024": [
      ...
      {
        id: 3,
        title: "Cloture Vote on Rikelman Nomination",
        description:
      ...
      {
        id: 5,
        title: "S. 4381, Right to Contraception Act",
        description:
      ...
      {
        id: 6,
        title: "OS. 4554, Reproductive Freedom for Women Act",
        description:
    ...
    "2021-2022": [
      ...
      {
        id: 5,
        title: "Becerra Vote to Report from Committee",
        description:
      ...
      },
      {
        ...
        description:
          "This procedural amendment would express Senate support for protecting the unborn from late-term abortion based on scientific consensus that these children can feel pain.",
      },
    ],
    "2019-2020": [
      {
      ...
      {
        id: 5,
        title: "Vote on the Motion to Proceed to Confirm Amy Coney Barrett",
        description:
      ...
      {
        id: 6,
        title: "Vote to Advance to the Final Confirmation of Amy Coney Barrett",
        description:
          "President Trump nominated Seventh Circuit Court of Appeals Judge Amy Coney Barrett to replace the late Associate Justice of the Supreme Court Ruth Bader Ginsburg. Judge Barrett is widely recognized as a brilliant, thoughtful jurist. A former clerk to Justice Antonin Scalia, Amy Barrett is a textualist and originalist with a profound respect for the constitution. She joined dissentals in abortion cases in the Seventh Circuit, standing up for the unborn who are targeted for abortion because of a eugenic goal, pointing out holes in Casey jurisprudence, and calling out the hypocrisy of protections for animals being given greater preference than protections for human babies.",
      },
      {
        id: 7,
        title: "Final Vote on the Confirmation of Amy Coney Barrett",
        description:
          "President Trump nominated Seventh Circuit Court of Appeals Judge Amy Coney Barrett to replace the late Associate Justice of the Supreme Court Ruth Bader Ginsburg. Judge Barrett is widely recognized as a brilliant, thoughtful jurist. A former clerk to Justice Antonin Scalia, Amy Barrett is a textualist and originalist with a profound respect for the constitution. She joined dissentals in abortion cases in the Seventh Circuit, standing up for the unborn who are targeted for abortion because of a eugenic goal, pointing out holes in Casey jurisprudence, and calling out the hypocrisy of protections for animals being given greater preference than protections for human babies.",
      },
    ],
      ...
      >
        ...
        {sessions[activeTab].map((vote) => (
          <Box key={vote.id} sx={{ width: "100%", mb: 3, color: "#66625C" }}>
            ...
            >
              <Typography variant="h2" color="#66625C" fontSize={54}>
                {vote.title}
              </Typography>
            </Box>
            ...
            <Typography paragraph sx={{ mb: 3 , fontSize:14 }}>
              {vote.description}
            </Typography>
